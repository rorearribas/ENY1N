...
namespace render
{
  ...
  void CCamera::Update(float _fDeltaTime)
  {
    ...
    maths::CVector3 vForward = maths::CVector3::Normalize(mRotMatrix * maths::CVector3::Forward);
    maths::CVector3 vRight = maths::CVector3::Normalize(mRotMatrix * maths::CVector3::Right);
