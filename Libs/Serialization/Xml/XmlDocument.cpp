...
{
  // ------------------------------------
  bool CXmlDocument::LoadFromFile(const char* _sPath, uint32_t _uMode, pugi::xml_encoding _eEncoding)
  {
    return m_oXmlDoc.load_file(_sPath, _uMode, _eEncoding) == pugi::status_ok;
  }
  // ------------------------------------
  bool CXmlDocument::LoadFromFile(const wchar_t* _sPath, uint32_t _uMode, pugi::xml_encoding _eEncoding)
  {
    return m_oXmlDoc.load_file(_sPath, _uMode, _eEncoding) == pugi::status_ok;
  }
  // ------------------------------------
  ...
  {
    return m_oXmlDoc.load_buffer(_pBuffer, _tSize, _uMode, _eEncoding) == pugi::status_ok;
  }
  // ------------------------------------
