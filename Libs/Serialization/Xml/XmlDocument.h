...
namespace serialization
{
  ...
  public:
    ...
    // Load XML
    bool LoadFromFile(const char* _sPath, uint32_t _uMode = pugi::parse_default, pugi::xml_encoding _eEncoding = pugi::encoding_auto);
    bool LoadFromFile(const wchar_t* _sPath, uint32_t _uMode = pugi::parse_default, pugi::xml_encoding _eEncoding = pugi::encoding_auto);
