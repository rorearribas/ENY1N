...
int main()
{
  ...
  render::primitive::CPrimitive* pPrimitive2 = pEngine->CreatePrimitiveItem(render::primitive::CPrimitive::EPrimitiveType::TRIANGLE, 1);
  pPrimitive2->SetColor(maths::CVector3(0.0f, 1.0f, 0.0f));

  render::primitive::CPrimitive* pPrimitive3 = pEngine->CreatePrimitiveItem(render::primitive::CPrimitive::EPrimitiveType::RECTANGLE, 2);
  pPrimitive3->SetColor(maths::CVector3(0.0f, 0.0f, 1.0f));

  const scene::CSceneManager* pSceneManager = pEngine->GetSceneManager();
  pSceneManager->DisableAllScenes();
  pSceneManager->SetSceneEnabled(2, true);
